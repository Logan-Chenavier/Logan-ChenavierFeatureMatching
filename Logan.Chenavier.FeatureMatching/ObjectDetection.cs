...
public class ObjectDetection
{
        ...
        objectImageData, IList<byte[]> imagesSceneData)
    {
        ...
        {
            new() {Points = new List<ObjectDetectionPoint> {new ObjectDetectionPoint {X = 10, Y = 10}}},
            new() {Points = new List<ObjectDetectionPoint>() {new ObjectDetectionPoint {X = 15, Y = 15}}}
        };
        return list;
    }
}